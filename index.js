...
const DB_URL =https://takei-net-default-rtdb.firebaseio.com/ "https://takei-net-default-rtdb.firebaseio.com/posts.json";
...
<div id="notice">
  ...
  <ul>
    <li>
      <p>【通知が出るようにりました。】</br>投稿できない場合は画面上のURLの左の南京錠マークをクリックし、【このサイトに対する権限】をクリックし、【通知】を許可にすることをお願いいたします。</br>●バグについて：スマートフォンにて通知が表示されないバグを発見し、対処しています。未知のバグを発見した場合は根田までお知らせください。【Ver.5.0.1】</p>
    </li>
  </ul>
</div>
